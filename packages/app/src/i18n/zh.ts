...
export const dict = {
  ...
  "toast.update.description": "KM Agent 有新版本 ({{version}}) 可安装。",
  ...
  "error.page.report.prefix": "请将此错误报告给 KM Agent 团队",
  ...
  "sidebar.gettingStarted.line1": "KM Agent 提供免费模型，你可以立即开始使用。",
  ...
  "settings.general.row.language.description": "更改 KM Agent 的显示语言",
  ...
  "settings.general.row.appearance.description": "自定义 KM Agent 在你的设备上的外观",
  "settings.general.row.colorScheme.title": "配色方案",
  "settings.general.row.colorScheme.description": "选择 KM Agent 跟随系统、浅色或深色主题",
  "settings.general.row.theme.title": "主题",
  "settings.general.row.theme.description": "自定义 KM Agent 的主题。",
  ...
  "settings.updates.row.startup.description": "在 KM Agent 启动时自动检查更新",
  ...
  "settings.updates.toast.latest.description": "你正在使用最新版本的 KM Agent。",
