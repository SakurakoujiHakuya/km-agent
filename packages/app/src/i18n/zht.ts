...
export const dict = {
  ...
  "toast.update.description": "KM Agent 有新版本 ({{version}}) 可安裝。",
  ...
  "error.page.report.prefix": "請將此錯誤回報給 KM Agent 團隊",
  ...
  "sidebar.gettingStarted.line1": "KM Agent 提供免費模型，你可以立即開始使用。",
  ...
  "settings.general.row.language.description": "變更 KM Agent 的顯示語言",
  ...
  "settings.general.row.appearance.description": "自訂 KM Agent 在你的裝置上的外觀",
  "settings.general.row.colorScheme.title": "配色方案",
  "settings.general.row.colorScheme.description": "選擇 KM Agent 要跟隨系統、淺色或深色主題",
  "settings.general.row.theme.title": "主題",
  "settings.general.row.theme.description": "自訂 KM Agent 的主題。",
  ...
  "settings.updates.row.startup.description": "在 KM Agent 啟動時自動檢查更新",
