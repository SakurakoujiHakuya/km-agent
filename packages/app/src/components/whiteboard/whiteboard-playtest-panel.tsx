...
export function WhiteboardPlaytestPanel(props: {
  ...
  const copy = createMemo(() =>
    props.chinese
      ...
      : {
          ...
          endpointHint: "This node has no outgoing link. Confirm that it is a completion, failure, or stage-end condition.",
  ...
  return (
    ...
    >
      ...
      <footer class="flex shrink-0 items-center gap-2 border-t border-v2-border-border-base p-3">
        <ButtonV2
