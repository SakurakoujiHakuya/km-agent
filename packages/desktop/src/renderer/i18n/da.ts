export const dict = {
  ...
  "desktop.updater.none.message": "Du bruger allerede den nyeste version af KM Agent",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} af KM Agent er blevet downloadet. Vil du installere den og genstarte?",
