export const dict = {
  ...
  "desktop.updater.none.message": "Već koristiš najnoviju verziju KM Agent-a",
  ...
  "desktop.updater.downloaded.prompt":
    "Verzija {{version}} KM Agent-a je preuzeta. Želiš li da je instaliraš i ponovo pokreneš aplikaciju?",
