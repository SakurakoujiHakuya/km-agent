export const dict = {
  ...
  "desktop.updater.none.message": "Vous utilisez déjà la dernière version de KM Agent",
  ...
  "desktop.updater.downloaded.prompt":
    "La version {{version}} de KM Agent a été téléchargée. Voulez-vous l'installer et redémarrer ?",
