export const dict = {
  ...
  "desktop.updater.none.message": "Korzystasz już z najnowszej wersji KM Agent",
  ...
  "desktop.updater.downloaded.prompt":
    "Pobrano wersję {{version}} KM Agent. Czy chcesz ją zainstalować i uruchomić ponownie?",
