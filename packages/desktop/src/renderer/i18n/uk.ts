export const dict = {
  ...
  "desktop.updater.none.message": "Ви вже використовуєте найновішу версію KM Agent",
  ...
  "desktop.updater.downloaded.prompt":
    "Версію {{version}} KM Agent завантажено. Бажаєте встановити її та перезапустити?",
