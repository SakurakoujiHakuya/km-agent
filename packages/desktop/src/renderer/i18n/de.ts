export const dict = {
  ...
  "desktop.updater.none.message": "Sie verwenden bereits die neueste Version von KM Agent",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} von KM Agent wurde heruntergeladen. Möchten Sie sie installieren und neu starten?",
