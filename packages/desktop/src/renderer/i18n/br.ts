export const dict = {
  ...
  "desktop.updater.none.message": "Você já está usando a versão mais recente do KM Agent",
  ...
  "desktop.updater.downloaded.prompt":
    "A versão {{version}} do KM Agent foi baixada. Você gostaria de instalá-la e reiniciar?",
