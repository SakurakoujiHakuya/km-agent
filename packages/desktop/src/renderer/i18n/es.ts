export const dict = {
  ...
  "desktop.updater.none.message": "Ya estás usando la versión más reciente de KM Agent",
  ...
  "desktop.updater.downloaded.prompt":
    "Se ha descargado la versión {{version}} de KM Agent. ¿Quieres instalarla y reiniciar?",
